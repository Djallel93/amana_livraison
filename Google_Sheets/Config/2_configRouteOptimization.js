...
const CONFIG_ROUTE_OPTIMIZATION = {
  ...
  get SAME_BUILDING_THRESHOLD_M() {
    return parseFloat(
      PropertiesService.getScriptProperties().getProperty(
        "ROUTE_SAME_BUILDING_THRESHOLD_M",
      ) || "50",
    );
  },
