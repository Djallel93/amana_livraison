...
const CONFIG_APIS = {
  ...
  API_GEO: {
    get URL() {
      return (
        PropertiesService.getScriptProperties().getProperty("API_GEO_URL") || ""
      );
    },
    get KEY() {
      return (
        PropertiesService.getScriptProperties().getProperty("API_GEO_KEY") || ""
      );
    },
    ENDPOINTS: {
      GEOCODE: "geocode",
...
const CONFIG_HQ = {
  ...
  HQ: {
    get ADRESSE() {
      return (
        PropertiesService.getScriptProperties().getProperty("HQ_ADRESSE") || ""
      );
    },
    get LAT() {
      return parseFloat(
        PropertiesService.getScriptProperties().getProperty("HQ_LAT") || "",
      );
    },
    get LNG() {
      return parseFloat(
        PropertiesService.getScriptProperties().getProperty("HQ_LNG") || "",
      );
    },
  },
